          ...
          <Namespaces>
            <Namespace name="http://www.composite.net/ns/management/bindingforms/std.ui.controls.lib/1.0">
              <Factories>
                ...
                <add userControlVirtualPath="~/Frontend/Composite/Forms/Renderer/Widgets/Selectors/DataReferenceTreeSelector.ascx" cacheCompiledUserControlType="false" type="Composite.Plugins.Forms.WebChannel.UiControlFactories.TemplatedDataReferenceTreeSelectorUiControlFactory, Composite" name="DataReferenceTreeSelector" />
                <add userControlVirtualPath="~/Frontend/Composite/Forms/Renderer/Widgets/Selectors/DataReferenceSelector.ascx" cacheCompiledUserControlType="false" type="Composite.Plugins.Forms.WebChannel.UiControlFactories.TemplatedDataReferenceSelectorUiControlFactory, Composite" name="DataReferenceSelector" />
                ...
                <add userControlVirtualPath="~/Frontend/Composite/Forms/Renderer/Widgets/TextInput/TextBox.ascx" cacheCompiledUserControlType="false" type="Composite.Plugins.Forms.WebChannel.UiControlFactories.TemplatedTextInputUiControlFactory, Composite" name="UrlComboBox" />
