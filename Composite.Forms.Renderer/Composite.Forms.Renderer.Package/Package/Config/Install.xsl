				...
				<Channel debugControlNamespace="http://www.composite.net/ns/management/bindingforms/internal.ui.controls.lib/1.0" debugControlName="Debug" name="AspNet.FormsRenderer">
					<Namespaces>
						<Namespace name="http://www.composite.net/ns/management/bindingforms/std.ui.controls.lib/1.0">
							<Factories>
								<add userControlVirtualPath="~/Frontend/Composite/Forms/Renderer/Widgets/DateTimeSelectors/DateSelector.ascx" cacheCompiledUserControlType="true" type="Composite.Plugins.Forms.WebChannel.UiControlFactories.TemplatedDateTimeSelectorUiControlFactory, Composite" name="DateSelector" />
								<add userControlVirtualPath="~/Frontend/Composite/Forms/Renderer/Widgets/DateTimeSelectors/DateSelector.ascx" cacheCompiledUserControlType="true" type="Composite.Plugins.Forms.WebChannel.UiControlFactories.TemplatedDateTimeSelectorUiControlFactory, Composite" name="DateTimeSelector" />
