...
>
	...
	<xsl:variable name="structure">
		<configSections>
			<add:section name="dotless" type="dotless.Core.configuration.DotlessConfigurationSectionHandler, dotless.Core" />
		</configSections>
		<dotless minifyCss="false" cache="true" />
		<system.web>
			<httpHandlers>
				<add:add add:key="path" type="dotless.Core.LessCssHttpHandler, dotless.Core" path="*.LESS" verb="*" />
			</httpHandlers>
		</system.web>
		<system.webServer>
			<handlers>
				<add:add name="Less css" type="dotless.Core.LessCssHttpHandler, dotless.Core" path="*.LESS" verb="*" />
			</handlers>
		</system.webServer>
	</xsl:variable>
