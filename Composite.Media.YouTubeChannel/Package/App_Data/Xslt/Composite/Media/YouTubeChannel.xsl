  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="~/Frontend/Composite/Media/YouTubeChannel/Scripts/jquery.youtubeplaylist.js" id="youtubeplaylist"></script>
        <xsl:if test="$lightbox='true'">
          <link id="youtube-lightbox-css" media="screen" type="text/css" href="/Frontend/Composite/Media/YouTubeChannel/lightbox-css/html-lightbox.css" rel="stylesheet" />
          <script id="youtube-lightbox-js" type="text/javascript" src="/Frontend/Composite/Media/YouTubeChannel/lightbox-js/jquery.html-lightbox.js"></script>
        </xsl:if>
