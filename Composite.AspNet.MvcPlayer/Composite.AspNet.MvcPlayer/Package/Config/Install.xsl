...
>
	...
	<xsl:variable name="structure">
		<system.web>
			...
			<pages>
				<namespaces>
					<add:add add:key="namespace" namespace="System.Web.Helpers" />
					<add:add add:key="namespace" namespace="System.Web.Mvc" />
					<add:add add:key="namespace" namespace="System.Web.Mvc.Ajax" />
					<add:add add:key="namespace" namespace="System.Web.Mvc.Html" />
					<add:add add:key="namespace" namespace="System.Web.Routing" />
					<add:add add:key="namespace" namespace="System.Web.WebPages"/>
				</namespaces>
			</pages>
		</system.web>
	...
	<xsl:template match="configuration/system.web/compilation/assemblies">
		<xsl:copy>
			...
			<xsl:if test="count(add[starts-with(@assembly,'System.Web.Abstractions')])=0">
