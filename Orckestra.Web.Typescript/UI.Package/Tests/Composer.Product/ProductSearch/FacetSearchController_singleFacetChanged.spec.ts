...
(() => {
    ...
    describe('WHEN calling the FacetSearchController.singleFacetChanged method', () => {
        beforeEach(() => {
            spy = sinon.spy();
        ...
        it('SHOULD publish the singleFacetChanged event.', () => {
            eventHub.subscribe('singleFacetsChanged', (eventInformation: Orckestra.Composer.IEventInformation) => {
                spy();
            });

            controller.singleFacetChanged(controllerActionContext);
