...
///<reference path='../../MyAccount/Common/CustomerService.ts' />
///<reference path='../../MyAccount/Common/MyAccountEvents.ts' />
///<reference path='../../MyAccount/Common/MyAccountStatus.ts' />
