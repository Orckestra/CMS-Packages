...
///<reference path='../Composer.Cart.UI/IRecurringOrderService.ts' />
///<reference path='../Composer.Cart.UI/RecurringOrderRepository.ts' />
///<reference path='./RecurringCartAddressRegisteredService.ts' />
///<reference path='../Composer.Store.UI/IStoreService.ts' />
///<reference path='../Composer.Store.UI/StoreService.ts' />
///<reference path='../Composer.UI/UIModal.ts' />
///<reference path='../Composer.Cart.UI/MonerisPaymentService.ts' />
///<reference path='./MyAccountEvents.ts' />
///<reference path='./DatepickerService.ts' />
///<reference path='../Composer.UI/Utils.ts' />
