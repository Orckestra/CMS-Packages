...
///<reference path='../Composer.UI/CustomerRepository.ts' />
///<reference path='../Composer.MyAccount.UI/CustomerService.ts' />
///<reference path='../Composer.MyAccount.UI/MyAccountEvents.ts' />
///<reference path='../Composer.MyAccount.UI/MyAccountStatus.ts' />
