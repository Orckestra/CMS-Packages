...
///<reference path='../../Cart/RecurringOrder/Services/RecurringOrderService.ts' />
///<reference path='../../Cart/RecurringOrder/Services/IRecurringOrderService.ts' />
///<reference path='../../Cart/RecurringOrder/Repositories/RecurringOrderRepository.ts' />
///<reference path='./RecurringCartAddressRegisteredService.ts' />
///<reference path='../../Store/Store/IStoreService.ts' />
///<reference path='../../Store/Store/StoreService.ts' />
///<reference path='../../UI/UIModal.ts' />
///<reference path='../../Cart/MonerisPaymentProvider/MonerisPaymentService.ts' />
