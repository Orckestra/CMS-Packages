...
public partial class Composite_InstalledPackages_content_views_Composite_Administration_Print_Print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            lPrintFrame.Text = string.Format(@"<iframe src=""{0}"" id=""printFrame"" name=""printFrame"" style=""width:100%;height:100%;background-color:white;"" onload=""PrintFrame(this);"" ></iframe>", pageUrl);
        }
    }
}