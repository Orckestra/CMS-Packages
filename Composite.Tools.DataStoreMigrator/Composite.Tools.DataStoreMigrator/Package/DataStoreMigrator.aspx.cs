...
public partial class DataStoreMigrator : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if (!Page.IsPostBack)
		{
			ddlSourceDataProvider.DataSource = DataFacade.GetDynamicDataProviderNames();
			ddlSourceDataProvider.DataBind();
			ddlTargetDataProvider.DataSource = DataFacade.GetDynamicDataProviderNames();
			ddlTargetDataProvider.DataBind();

			ddlSourceDataProvider.Items.FindByValue("DynamicXmlDataProvider").Selected = true;
			ddlTargetDataProvider.Items.FindByValue("DynamicSqlDataProvider").Selected = true;
